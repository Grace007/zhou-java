...
import com.zhou.util.bds.ProgressBarThread;
...
public class DownJarUtil {
	...
	public static String download(String url, String savePath, String fileName) {
		try {
			...
			ProgressBarThread pbt = new ProgressBarThread((int) entity.getContentLength(), fileName);// 创建进度条
	...
	public static void main(String[] args) {
		...
		String url = "http://211.152.47.77:8000/pan/upload/bds.weixin-0.0.1.jar";
		// String filepath = "D:\\test\\a.torrent";
		String filepath = "D:\\test";
		DownJarUtil.download(url, filepath,"aa.jar");
	}
}
